  ...
  return (
    <section className="min-h-screen flex flex-col justify-center px-8 max-w-5xl mx-auto">
      ...
      <div className="flex gap-4">
        <button className="bg-purple-500 hover:bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 hover:-translate-y-1">
          View Projects
        </button>
        <button className="border border-sky-400 text-sky-400 hover:bg-sky-400/10 px-6 py-3 rounded-lg font-semibold transition-all duration-200 hover:-translate-y-1">
          Talk to NOVA
        </button>
      </div>
    </section>
